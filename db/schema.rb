...
ActiveRecord::Schema.define(version: 2023_08_16_210916) do
  ...
  create_table "shipping_adresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_shipping_adresses_on_purchase_record_id"
  end
  ...
  add_foreign_key "shipping_adresses", "purchase_records"
end
